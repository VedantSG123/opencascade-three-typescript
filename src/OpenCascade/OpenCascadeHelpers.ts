...
const loadFileAsync = (file: File): Promise<string> => {
...
function getBufferGeometryFromShape(
  shape: TopoDS_Shape,
  openCascade: OpenCascadeInstance
): THREE.BufferGeometry<THREE.NormalBufferAttributes>[] {
  let geometries: Array<THREE.BufferGeometry<THREE.NormalBufferAttributes>> = []
...
export { loadFileAsync, fileType, getBufferGeometryFromShape }
